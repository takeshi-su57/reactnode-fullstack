    ...
    <div>
      ...
      <div className="row">
        <div className="col-sm-6">
          <img className="img-fluid float-left" src="/assets/nodejs.png" alt="NodeJs" width="140" height="140" />
          <h2>NodeJs</h2>
        ...
        <div className="col-sm-6">
          <img className="img-fluid float-left" src="/assets/react.png" alt="React" width="140" height="140" />
          <h2>React</h2>
