...
const { chance, ONLINE, OFFLINE, AWAY, FETCHED } = require('../constants');
...
const getRandomMessageText = () => template(chance.pick(templates))({
...
module.exports = {
    getRandomMessageText, getRandomMessage, initializeDB
}